...
\begin{frame}{Экзамен и финальная оценка}
  \begin{itemize}
    \item допуск к экзамену -- 50 баллов \vspace{1em}
    \item без прихода на экзамен: $E \geq 65; D \geq 85; C \geq 100; B \geq 125; A \geq 150$ \vspace{1em}
    \item первая часть экзамена -- блиц-опрос; $+ 1$ к финальной оценке \vspace{1em}
    \item вторая часть экзамена (по желанию) -- 2 теоретических вопроса \vspace{1em}
