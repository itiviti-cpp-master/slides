...
\begin{frame}[fragile]{Интегральные преобразования}
  ...
  \begin{itemize}
    \item $T2 \in \mathbb{U}, \mathbf{sizeof}(T1) > \mathbf{sizeof}(T2) \implies$ результат -- младшие биты исходного представления \vspace{1em}
    \item $T2 \in \mathbb{U}, T1 \in \mathbb{S}, \mathbf{sizeof}(T1) \leq \mathbf{sizeof}(T2) \implies$ результат -- знаковое дополнение \vspace{1em}
    \item $T2 \in \mathbb{U}, T1 \in \mathbb{U}, \mathbf{sizeof}(T1) \leq \mathbf{sizeof}(T2) \implies$ результат -- дополнение нулями \vspace{1em}
    \item $T2 \in \mathbb{S}$ и исходное значение помещается в $T2 \implies$ значение не меняется \vspace{1em} \vspace{1em} \vspace{1em} \vspace{1em}
...
\begin{frame}[fragile]{Преобразования с \lstinline{bool}}
  \[
    ...
    \forall T: T \in \mathbb{I} \lor \mathbb{F}, T \mapsto \mathtt{bool}
  \]
  ...
  \begin{itemize}
    \item $value \neq 0 \implies$ \lstinline{true} \vspace{1.5em}
