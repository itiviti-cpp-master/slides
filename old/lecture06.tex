...
\lstinputlisting[firstline=216,lastline=220,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}
...
\lstinputlisting[firstline=250,lastline=257,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}

\end{frame}

\begin{frame}[fragile]{sort\_stream}

\lstinputlisting[firstline=192,lastline=214,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}

\end{frame}

\begin{frame}[fragile]{print\_out}

\lstinputlisting[firstline=179,lastline=190,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}

\end{frame}

\begin{frame}[fragile]{MultiSet}

\lstinputlisting[firstline=155,lastline=175,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}
...
\lstinputlisting[firstline=11,lastline=37,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}
...
\lstinputlisting[firstline=68,lastline=94,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}
...
\lstinputlisting[firstline=39,lastline=66,basicstyle=\ttfamily\srcbigsize]{examples/sort.cpp}
...
\lstinputlisting[firstline=96,lastline=131,basicstyle=\ttfamily\srcsize]{examples/sort.cpp}
